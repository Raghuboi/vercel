...
export const connectSubcommand = {
  ...
  examples: [
    ...
    },
    {
      ...
      value: `${packageName} ai-gateway coding-agents connect --agent claude-code --budget 500 --refresh-period monthly`,
    },
    {
      name: 'Rotate the key on an already-configured setup',
      value: `${packageName} ai-gateway coding-agents connect --reconfigure`,
    },
  ],
} as const;
